    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:\\Attendance\\Attendance\\Manually Attendance\\'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\Attendance\Attendance\Manually Attendance')
...
def subjectchoose():
            ...
            if sub == '':
                ...
                with open(cs, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(root, width=17, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="white", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\Attendance"')
    ...
    def log_in():
        ...
        if username == 'chitransh':
            if password == 'chitransh123':
                ...
                cs = r'D:\Attendance\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
